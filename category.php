...
<html lang="en">
       ...
       // include 'database.php'; 
        ...
        @@$idArr = $_POST['chk'];
         ...
         if (empty($_POST["chk"])) {
                        ...
                        alert("Please Selece Check Box");window.location.href="category.php";
                        </script>';
        ...
        else
        {
         ...
         foreach($idArr as $category_id)
         {
            $res=$obj->categorymuldel($category_id);
 ...
 ?>
  ...
  <div class="container-fluid">
    ...
    <center><h1 class="text">Category Details</h1></center>
    ...
    <tbody>
      <?php
          ...
          <?php
              ...
              <td><a href="categoryedit.php?category_id='.$category_id.'" class="btn btn-success"><span class="glyphicon glyphicon-pencil" arial-hidden="true"></span></a>
              <a href="categoryaction.php?category_id='.$category_id.'" class="btn btn-danger" onClick="return del()" ><span class="glyphicon glyphicon-trash" arial-hidden="true"></span></a></td>
              </tr>';
