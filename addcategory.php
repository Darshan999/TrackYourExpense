...
<html lang="en">
  ...
  function allLetter(category_name)
{
  var letters=/^[A-Za-z]+$/;
  if(category_name.value.match(letters))
  {
      return true;
  }
  else
  ...
  <div class="container-fluid">
   ...
   <?php
            ...
            $obj1=new database();
            $res1=$obj1->insertcategory($category_name);
                          ...
                          <div class="panel-body">
                                  ...
                                  <form class="form-horizontal " method="post" action="" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                               <input class="form-control " id="catname" name="category_name" type="text" placeholder="Enter Name " onblur="return allLetter(category_name);" required="" />
                                          </div>
                                          </div>
